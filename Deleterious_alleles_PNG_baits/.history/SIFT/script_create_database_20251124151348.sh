...
cp ~/projects/rbge/tmichel/reference_genomes/Bmas.fa    data/genomes/Bmas.fa
cp ~/projects/rbge/tmichel/reference_genomes/Bmas.gff   data/Bmas/genes.gff
cp ~/projects/rbge/tmichel/reference_genomes/Bmas.cds   data/Bmas/cds.fa
cp ~/projects/rbge/tmichel/reference_genomes/Bmas.pep   data/Bmas/protein.fa

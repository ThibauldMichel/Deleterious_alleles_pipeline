...
# HERE IS A LOOP FOR HYPHY MEME, BUT I AM TESTING A SCPECIFIC SCRIPT
...
#  pathout="output_meme/${locus}_MEME.fna"
#  logdir="logs"
#  mkdir -p "$logdir"  # Ensure the logs directory exists
#
#  # Run HyPhy and redirect both stdout and stderr to a log file named after the locus
#  hyphy meme \
#    --alignment "$pathmsa" \
#    --tree "$pathtree" \
#    --branches All \
